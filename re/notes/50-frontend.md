...
| 16de | "<name> IS OUT!!": the driver is marked 0x20 on the carousel, their face drops off the bottom of the screen a few rows at a time (the table at [034b]), then fn 1a4a fills the empty seat |
