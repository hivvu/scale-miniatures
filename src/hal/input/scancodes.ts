/** DOM `KeyboardEvent.code` to XT scancode (set 1). Extended keys keep their base code: the game's int 9
 *  handler notes the E0 prefix but matches on the code that follows it, so the arrows are the keypad keys. */
export const SCANCODE: Record<string, number> = {
  ...
  // extended keys, by the scancode that follows E0
  ArrowUp: 0x48, ArrowDown: 0x50, ArrowLeft: 0x4B, ArrowRight: 0x4D, Insert: 0x52, Delete: 0x53,
  Home: 0x47, End: 0x4F, PageUp: 0x49, PageDown: 0x51, NumpadEnter: 0x1C, ControlRight: 0x1D,
  AltRight: 0x38, NumpadDivide: 0x35,
};
